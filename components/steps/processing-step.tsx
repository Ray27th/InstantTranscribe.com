    ...
    if (processingJob && processingJob.status === "processing" && !isTranscribing) {
      ...
      const transcribeFile = async () => {
        try {
          ...
          // Fallback to demo transcript if API fails
          const fallbackResult: TranscriptionResult = {
            fullTranscript: `Demo mode: Full transcription of ${file.name}. 
            
This is a sample full transcription that would contain the complete text from your audio file. In a real scenario, this would be the actual transcription generated by OpenAI Whisper API.

The transcription would include speaker identification, proper punctuation, and timestamp information for creating subtitle files.

Your actual transcription service is working, but this is demo content to show the complete workflow from upload to download.`,
            confidence: 0.89,
            segments: [
              { text: "Demo mode: Full transcription sample.", start: 0, end: 5 },
              { text: "This shows the complete workflow.", start: 5, end: 10 },
              { text: "Your service is working properly.", start: 10, end: 15 }
            ],
            speakerCount: 1
          }
          ...
          setTimeout(() => {
            onProcessingCompleted(fallbackResult)
          }, 1500)
        }
      }
